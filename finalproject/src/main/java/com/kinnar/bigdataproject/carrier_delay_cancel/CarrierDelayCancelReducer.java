...
public class CarrierDelayCancelReducer extends Reducer<Text, DelayRatioTuple, Text, DelayRatioTuple> {	

	private DelayRatioTuple tuple = new DelayRatioTuple();
	@Override
	protected void reduce(Text key, Iterable<DelayRatioTuple> values, Context context) throws IOException, InterruptedException {
		int total=0;
        int delayedTotal=0;
