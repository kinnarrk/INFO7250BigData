 ...
 * @author kinnar
 */
public class CarrierDelayController extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet CarrierDelayController</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet CarrierDelayController at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
...
//            FileSystem fs = filePath.getFileSystem(conf);
            ...
            try {
                ...
                Path file = new Path("hdfs://localhost:9000/project/CarriersDelayCancel/part-r-00000");
...
//                        System.out.println("data2:" + Arrays.toString(data2));
            ...
            RequestDispatcher rd = request.getRequestDispatcher("carrier_flight_delay.jsp");
